...
namespace AzRebit.Tests.UnitTests.Triggers.Http;
...
public class FunctionExample_Http
{
    ...
    [Theory]
    [InlineData("GetCats", "31b60c2b-fe87-4519-9630-3a56a63772d4")]
    public async Task Resubmit_WhenResubmitIsRequest_ShouldSuccesfullyResubmitTheRequest(string functionName,string invocationId)
    {
        ...
        TestOutput.WriteLine(await resubmitResponse.Content.ReadAsStringAsync());
    }
}
